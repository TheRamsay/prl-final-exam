# 2020/2021 - řádný termín - zkratka
...
1. PRAM: cena XOR, časová složitost OR, cena součtu/maxima/minima.
2. Test-and-set.
3. Kauzalita.
4. Eulerův tah, suffix.
5. Ricart-Agrawala.
6. Euler strom/graf.
7. Carry-look-ahead: spočítat `39 + 110`.
8. MPI: v logaritmické složitosti součet hodnot větších než průměr.
