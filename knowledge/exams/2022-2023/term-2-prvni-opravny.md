...
1. PRAM tipovačka.
2. Odd-even transposition sort: algoritmicky, analýza, cena.
3. Princip paralelního selectu a příklad.
4. Marzullův algoritmus.
5. Pi-kalkul: najít 3 možné redukce.
6. CLA příklad: `120 + 99`.
7. Čtyři čítači.
8. MPI.
